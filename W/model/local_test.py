...
train_dataset = LEVIR_CD_Dataset('./data/mydataset/train',
                                 sub_dir_1='Ab',
                                 sub_dir_2='Bb',
                                 img_suffix='.png',
                                 ann_dir='./data/mydataset/train/label',
                                 debug=False)

valid_dataset = LEVIR_CD_Dataset('./data/mydataset/val',
                                 sub_dir_1='Ab',
                                 sub_dir_2='Bb',
                                 img_suffix='.png',
                                 ann_dir='./data/mydataset/val/label',
                                 debug=False,
                                 test_mode=True)
...
model = torch.load("best_modelpng_My.pth")
model.eval()
max_score = 0
MAX_EPOCH = 100
...
for i in range(MAX_EPOCH):
    ...
    if max_score < valid_logs['fscore']:
        ...
        torch.save(model, './best_modelpng_continueTry.pth')
        print('Model saved!')
